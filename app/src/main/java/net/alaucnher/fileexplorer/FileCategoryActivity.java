...
import net.alaucnher.fileexplorer.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import net.alaucnher.fileexplorer.FileCategoryHelper.CategoryInfo;
import net.alaucnher.fileexplorer.FileCategoryHelper.FileCategory;
import net.alaucnher.fileexplorer.FileExplorerTabActivity.IBackPressedListener;
import net.alaucnher.fileexplorer.FileViewInteractionHub.Mode;
import net.alaucnher.fileexplorer.Util.SDCardInfo;
    ...
    private class ScannerReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_MEDIA_SCANNER_FINISHED) || action.equals(Intent.ACTION_MEDIA_MOUNTED)
                    || action.equals(Intent.ACTION_MEDIA_UNMOUNTED) || action.equals(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE)) {
                notifyFileChanged();
            }
        }
    }
